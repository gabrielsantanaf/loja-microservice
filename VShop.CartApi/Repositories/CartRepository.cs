...
namespace VShop.CartApi.Repositories
{
    public class CartRepository : ICartRepository
    {
        ...
        public async Task<CartDTO> UpdateCartAsync(CartDTO cartDTO)
        {
            ...
            //salva o produdo no banco se ele não existir
            ...
            else
            {
                ...
                await UpdadeQuantityAndItems(cartDTO, cart,  cartHeader);
            }

            return _mapper.Map<CartDTO>(cart);
        }

        private async Task UpdadeQuantityAndItems(CartDTO cartDTO, Cart cart, CartHeader? cartHeader)
        {
            /*
